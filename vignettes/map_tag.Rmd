...
The packages you will use are __map__, __fgeo.utils__, __ggplot2__ and __dplyr__. __map__ contains the function `map_tag()`;  __fgeo.utils__ contains utility functions; and __ggplot2__ and __dplyr__ provide powerful tools for vizualizing and wrangling data. (These packages are part of the tidyverse (https://www.tidyverse.org/) -- a collection of R packages designed for data science. All packages share an underlying philosophy and common APIs.)

```{r show-chunk-that-was-hidden-above}
<<pkg-hide>>
```
