...
This vignette shows the same code that you can find in the help files of `map_sp()`, `maply_quad()` and `maply_tag()`, but here (not in in the help files) you can see the output.
...
# `maply_quad()`: Map trees within a quadrat
