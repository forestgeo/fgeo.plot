...
This vignette shows the same code that you can find in the help files of `map_sp()`, `map_quad()` and `map_tag()`, but here you can see the output (not in in the helpfile).
