...
# install_github("forestgeo/map", auth_token = GITHUB_PAT)
library(map)
...
example_data <- as_tibble(bciex::bci12t7mini)
...
## ---- fig.align="default", out.width="45%", fig.widh=(6 * 0.45 / 0.7)----
map_sp(
  census, "hybapr", theme = theme_map_sp(panel.grid.minor = element_blank())
)
