...
Once the data is prepared, this is all we need to produce the default plots:
...
## Common tweaks via `lapply_plot_repulsive_tags()`

The arguments of `lapply_plot_repulsive_tags()` give you common options (See `?lapply_plot_repulsive_tags()`).
...
## Detailed tweaks via `get_header()`
