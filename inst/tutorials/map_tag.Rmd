...
You should be able to change the size of the quadrat and subquadrats, but currently this feature is not working correctly. I'll fix it shorly. What are the possible quadrat sized?

```{r}
maps <- map_tag(renamed, site_name = "BCI 2012", 
  x_q = 10, x_sq = 2.5, y_q = 10, y_sq = 2.5
)
pdf("smaller.pdf")
maps[1:4]
dev.off()
