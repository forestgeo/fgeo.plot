...
You can customize the dimension of your quadrats and subquadrats. The next example also shows how the argument `extend_grid` can be useful. Let's start by defining a quadrat side of 10 meters and a subquadrat side of 2.5 meters. Notice that the limits of the subquadrats aren't mapped.

```{r}
map_tag(renamed, site_name = "BCI 2012", 
  x_q = 10,  # side of a quadrat in meters
  x_sq = 2.5  # side of a subquadrat in meters
)[[1]]
```

To fix this problem -- to plot the missing limits -- you can use `extend_grid`.
...
### xxx 100x100 quadrats

```{r}
map_tag(renamed, site_name = "BCI 2012", 
  x_q = 100,  # side of a quadrat in meters
  x_sq = 25  # side of a subquadrat in meters
)[[1]]
```
...
```{r}
map_tag(renamed, site_name = "BCI 2012", 
  x_q = 200,  # side of a quadrat in meters
  x_sq = 50  # side of a subquadrat in meters
)[[1]]
```
...
map_tag(renamed, site_name = "BCI 2012", 
  ...
  x_sq = 20  # side of a subquadrat in meters
)[[1]]
```
