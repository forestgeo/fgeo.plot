...
This vignette shows you how to map the latest tree-status in subquadrats with  `map_tag()`, which currently lives in the __try__ package but will be moved to the __forestr__ package after receiving some feedback.
