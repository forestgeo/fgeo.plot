...
The range is between around 0 and 20. That is why we've been using using the defult quadrat dimension of 20 meters (`x_sq` and `y_sq`), and the default subquadrat dimension of 5 meters (`x_sq` and `y_sq`).
...
If you ever want to calculate the variable `subquadrat`, you can do that with `add_subquadrat()`.
`add_subquadrat()`
