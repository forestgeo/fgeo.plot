...
This image should flag that you have this kind of problem -- by which the range of data is smaller than quadrat and subquadrat dimensions you set. Notice that the points are all between `qx` and `qy` ranging 0-20. The tags, however, go beyond 20 because they automatically reppel themselves to avoid overlapping.
