...
I'l use __dplyr__ and __ggplot2__ for data wrangling and visualization. Also, I'll use __ggrepel__ to avoid overlaping on the maps; [__fgeo.map__](https://github.com/forestgeo/map) which contains an example dataset.
