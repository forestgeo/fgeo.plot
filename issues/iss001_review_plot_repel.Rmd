...
> Mauro, let’s print a few quadrats of different densities and finalize on Monday. {using tree tag size 3}
...
density_diverse <- sinh_q20[name_of_density_diverse]
```

```{r}
pdf(onefile = TRUE, paper = "a4", width = 11, height = 11)
lapply_plot_repel(density_diverse["16"], site = this_site)
dev.off()
```
