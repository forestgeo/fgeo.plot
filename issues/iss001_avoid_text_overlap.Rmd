...
n_cols_per_df <- unlist(unique(lapply(sinh_q20, ncol)))
str(sinh_q20[1:3])
```
...
sinh_q20 <- lapply(sinh_q20, convert_status_to_character)
sinh_q20 <- lapply(sinh_q20, convert_symbol_to_factor)
...
selected_quadrats <- sinh_q20[name_of_selected_quad]
